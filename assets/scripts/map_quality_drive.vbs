...
If StrComp("\\10.20.2.121\Q", objItem.ProviderName) Then
Else
...
'if it is not mapped, we are going to delete whatever it is on the Q: drive to make space
driveLetter = "Q:"
...
strRemoteShare = "\\10.20.2.121\Q"
objNetwork.MapNetworkDrive driveLetter, strRemoteShare, True
objShell.NameSpace(driveLetter).Self.Name = "Quality (\\USpharmaltd.com)"
